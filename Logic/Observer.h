...
namespace logic {
    ...
    enum Events { NO_EVENT, GAME_OVER, LEVEL_COMPLETED, DIRECTION_CHANGED, ISMOVING_CHANGED, DEATH, RESPAWN, FRUIT_EATEN, GHOST_EATEN, COIN_EATEN, SCORE_UPDATE, GHOST_FRIGHTENED, GHOST_NORMAL };
